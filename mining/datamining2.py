...
browser.find_element('name', 'timed_vocab').click()
time.sleep(3)
...
for i in range(30000): 
    ...
    word1 = browser.find_element('xpath', '//*[@id="timedVocab_lemma"]').text
    dec1 = browser.find_element('xpath', '//*[@id="timedVocab_def"]').text
    print(word1)
    print(dec1)
